<template>
    ...
    <section id="whatCando" class="bg-color-primary-light">
        <div class="container py-20">
            <div>
                <h1 class="text-3xl md:text-4xl  text-center font-bold mb-10">Functionalities TaskFocus have?</h1>
            </div>
