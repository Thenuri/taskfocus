<template>
  ...
  <div class="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiase text-black ">
    <div class="h-full ml-14 mt-14 mb-10 md:ml-64">

      <!-- Statistics Cards -->
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 p-4 mt-1 gap-4">
        <div
          class=" container1  shadow-lg rounded-2xl flex items-center justify-between p-3  text-blue-950 font-medium group">
          <div
        ...
        <div
          class="container2 shadow-lg rounded-2xl flex items-center justify-between p-3   text-blue-950 font-medium group">
          <div
            class="flex justify-center items-center w-14 h-14   rounded-full transition-all duration-300 transform group-hover:rotate-12">
